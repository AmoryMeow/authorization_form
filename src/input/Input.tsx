  ...
  return (
    <div className="input-box">
      ...
      {type === "password" && (
        ...
        >
          {passwordVisible ? <IconCloseEye /> : <IconOpenEye />}
        </span>
      )}
...
const IconCloseEye = () => {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M-896-256H384v800H-896z" fill="none" />
